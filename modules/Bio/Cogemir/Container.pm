...
=head1 NAME - Bio::Cogemir::DBSQL::Container

=head1 SYNOPSIS

$container = new Bio::Cogemir::Container($obj);
...
Post questions to the Cogemir developer mailing list: <ensembl-dev@ebi.ac.uk>
...
=head2 new
  ...
  Arg [1]    : Bio::Cogemir::DBAdaptor $dba
               The dbadaptor to wrap this holder around.
  Example    : $dba_holder = new Bio::Cogemir::DBSQL::DBAdaptorHolder($dba);
  ...
  Returntype : Bio::Cogemir::DBAdaptorHolder
  Exceptions : none
...
sub DESTROY {
  ...
  #print STDERR "Container::DESTROY : Breaking circular references:\n";
  	...
  	if(!$obj) {
    	#warn("Bio::Cogemir::Container: potential memory leak, contained"
